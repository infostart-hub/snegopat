...
import { global, File, FormItems, Map, TextBox, ValueTable, ValueTableRow, Form, ЗначениеИзСтрокиВнутр, CreateDirectory, DeleteFiles, FindFiles, ValueTreeRow } from "v8_1c";
