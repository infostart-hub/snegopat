...
Снегопат доступен всем желающим в виде бесплатной триальной версии. Получить триальную версию нужно на :arrow_heading_up: [официальной странице проекта на портале INFOSTART](https://infostart.ru/public/102065/).
