...
Процедура ПослеПоискаФайловАнализа(ФайлыДампаКАнализу, ФайлыРабочегоДампа) Экспорт
	...
	ПрочитатьФайлы(ОбщиеФайлы);
	
КонецПроцедуры

&НаКлиенте
Процедура ПрочитатьФайлы(ФайлыДляАнализа)
	...
	Для Каждого ФайлДляАнализа Из ФайлыДляАнализа Цикл
		...
		Для Каждого СтрокаФункции Из данныеДампаКАнализу.Функции Цикл
			НайденныеСтроки = Объект.Функции.НайтиСтроки(Новый Структура("Файл, НомерФункцииРаб", ФайлДляАнализа.Ключ, СтрокаФункции.Номер));
